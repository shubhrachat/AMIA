...
The second agent improves the accuracy of the analysis using recent and live data from the internet, implemented using an MCP client and server built with DuckDuckGo.
